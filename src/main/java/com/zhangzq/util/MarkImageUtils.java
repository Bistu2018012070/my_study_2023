...
public class MarkImageUtils {
    ...
    public static void main(String[] args) {
        String output = "H:/User/Pictures/";
        String source = "H:/User/Pictures/屏幕截图_20221025_100352.png";  //源图片路径
        String icon = "H:/User/Pictures/upload.png"; //覆盖图片路径
        ...
        //2给图片添加文字水印
        // result = MarkImageUtils.markImageByMoreText(source,output,imageName,imageType,Color.BLUE,text,degree);
